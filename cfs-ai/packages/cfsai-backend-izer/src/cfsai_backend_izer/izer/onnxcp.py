                    ...
                    if w.ndim > 1:  # not a bias
                        ...
                        if w.ndim == 2:  # MLP
                            if kernel_size_onnx[seq][0] != 1 or kernel_size_onnx[seq][1] != 1:
                                raise IzerError(f'The `kernel_size` for the MLP layer {seq} should '
                            ...
                            if kernel_size_onnx[seq][0] != w.shape[2] \
                               or kernel_size_onnx[seq][1] != 1:
                                raise IzerError(f'The `kernel_size` for the 1D layer {seq} should '
                            ...
                            if kernel_size_onnx[seq][0] != w.shape[2] \
                               or kernel_size_onnx[seq][1] != w.shape[3]:
                                raise IzerError(f'The `kernel_size` for the 2D layer {seq} should '
