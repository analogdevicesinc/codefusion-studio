...
export namespace DwarfData {
	...
	export const enum DW_VIRTUALITY {
		none = 0x00,
		virtual_ = 0x01,
		pure_virtual = 0x02,
	}
			...
			switch (form) {
				...
				case DW_FORM.data8:
					...
					switch (name) {
						...
						case DW_AT.vtable_elem_location:
						case DW_AT.ranges:
							// Fall to DW_FORM.sec_offset
							return TypeResolver.resolveType(name, DW_FORM.sec_offset);
						default:
							// Fall through
							break;
					}
				...
				case DW_FORM.udata:
					return ValueType.uconstant;
				case DW_FORM.sdata:
					return ValueType.sconstant;
				...
				case DW_FORM.sec_offset:
					...
					switch (name) {
						...
						case DW_AT.start_scope:
						case DW_AT.ranges:
							return ValueType.rangelist;

						default:
							if (name >= DW_AT.lo_user && name <= DW_AT.hi_user) {
