...
import PinAssignmentStatusFilter from './pin-assignment-status-filter';
...
describe('Filter Controls', () => {
	it('Selects/deselects filters correctly', () => {
		...
		cy.mount(<PinAssignmentStatusFilter />, reduxStore);
	...
	it('Removes pin conflict and disables conflict chip', () => {
		...
		cy.mount(<PinAssignmentStatusFilter />, reduxStore).then(() => {
			cy.wrap(
				reduxStore.dispatch(
					removeAppliedSignal({
						Pin: '39',
