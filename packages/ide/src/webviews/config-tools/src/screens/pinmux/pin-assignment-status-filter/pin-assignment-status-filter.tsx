...
import {computePinState} from '../utils/filters';

import styles from './pin-assignment-status-filter.module.scss';
...
import {
	useActivePinconfigAssignmentFilter,
	useSearchString
...
function PinAssignmentStatusFilter() {
...
export default PinAssignmentStatusFilter;
