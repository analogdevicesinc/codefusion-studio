...
ASSETS_PREFIX = Path(__file__).parent / 'backend'
...
defaults = parse_json((ASSETS_PREFIX / "assets").joinpath("vscode", "defaults", "settings.json"))
...
def vscode(
    ...
    template_dir = (ASSETS_PREFIX / "assets").joinpath("vscode", "template").resolve()
...
def makefile(
    ...
    **kwargs
    ...
    template_makefile = (ASSETS_PREFIX / "assets").joinpath("makefile", "Makefile").resolve()
    template_projectmk = (ASSETS_PREFIX / "assets").joinpath("makefile", "project.mk").resolve()
