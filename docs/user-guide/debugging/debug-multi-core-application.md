...
1. [Create a multi-core workspace using the Workspace Creation Wizard](#option-1-create-a-multi-core-workspace-using-the-workspace-creation-wizard)
2. [Create a multi-core workspace by combining two SDK examples](#option-2-create-a-multi-core-workspace-by-combining-sdk-examples)
...
1. Create a new directory, such as `MAX78002_Multicore`, outside the SDK examples folder.
