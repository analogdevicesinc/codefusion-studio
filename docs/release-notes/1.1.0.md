...
CodeFusion Studio source can be found on {git-codefusion-studio}`GitHub <releases/tag/V1.1.0+>` under tag `V1.1.0`
...
- Support for Zephyr RTOS 4.1 [Get started](https://docs.zephyrproject.org/4.1.0/)
- Support for the Micro SDK (MSDK) [Get started with MSDK](https://analogdevicesinc.github.io/msdk/USERGUIDE/)
...
- CodeFusion Studio is not compatible with VS Code version 1.99. This is expected to be resolved in newer versions of VS Code. [VS Code v1.98](https://code.visualstudio.com/updates/v1_98) is known to be compatible with CodeFusion Studio.
...
- Segger JLink does not support all parts. See the following table for details. For a list of supported devices, see the [Segger website](https://www.segger.com/supported-devices/jlink/maxim/).
