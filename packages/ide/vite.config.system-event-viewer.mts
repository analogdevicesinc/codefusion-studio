...
export default defineConfig({
  root: path.resolve(__dirname, "./src/webviews/system-event-viewer"),
  plugins: [react()],
  resolve: {
    alias: {
  ...
  build: {
    outDir: path.resolve(__dirname, "./out/system-event-viewer"),
    emptyOutDir: true,
    target: "esnext",
    rollupOptions: {
      input: path.resolve(
        __dirname,
        "./src/webviews/system-event-viewer/index.html",
      ),
      output: {
